...
If you use `moon` in published work, please cite **both** the software and
the original model paper. Running `citation("moon")` returns these entries.

**Software** (this package):

> Damslund N, Bjørnelv GMW, Jiang Y, Larsen MS, Edwards CH, Halsteinli V,
> Ødegaard RA, Kongstad LP (2026). *moon: An R Package Implementing the
